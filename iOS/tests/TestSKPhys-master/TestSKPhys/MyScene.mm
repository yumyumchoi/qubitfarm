...
float boxWidth = BIG_BOX_WIDTH;//SMALL_BOX_WIDTH;
float boxHeight = BIG_BOX_HEIGHT;//SMALL_BOX_HEIGHT;
...
//    CGSize newBoxDimension =  CGSizeMake((arc4random_uniform(newBoxHalf.width)) + newBoxHalf.width, (arc4random_uniform(newBoxHalf.height)) + newBoxHalf.height);
    
//    NSLog(@"box dimension = %@",NSStringFromCGSize(newBoxDimension));
